...
- [ ] The review names every registry field left **unrestricted**, in plain words, as its own part of
...
- [ ] Every sentence shown is generated from the `Rule` object (LEASH-174's renderer); no model prose
